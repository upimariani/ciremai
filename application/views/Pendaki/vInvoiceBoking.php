                        ...
                        <div class="row invoice-info">
                            <div class="col-sm-4 invoice-col">
                                ...
                                <address>
                                    ...
                                    <?= $detail['transaksi_boking']->no_hp_pendaki ?><br>
                                </address>
                            </div>
                            <!-- /.col -->
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php if ($value->stat_pem_dp_boking == '0' && $value->stat_pem_all_boking == '0' && $value->stat_boking == '0') {
                                                    ?>
                                                        <span class="badge badge-danger">Belum Bayar</span>
                                                    <?php
                                                    } else if ($value->stat_pem_dp_boking != '0' && $value->stat_pem_all_boking == '0' && $value->stat_boking == '0') {
                                                    ?>
