        ...
        <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center">
                <div class="intro-wrap">
                    <h1 class="mb-0">Checkout Guide dan Porter</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
                ...
                <div class="custom-block" data-aos="fade-up">
                    ...
                    <div class="custom-accordion" id="accordion_1">
                        <div class="accordion-item">
                            <h2 class="mb-0">
                                <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Bagaimanaa Cara Boking Guide dan Porter?</button>
                            </h2>

                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion_1">
                                <div class="accordion-body">
                                    Masuk ke halaman login -> Pilih Guide dan Porter yang dibutuhkan -> "Add To Cart" -> Klik Checkout
                                </div>
                            </div>
                        </div> <!-- .accordion-item -->
                        ...
                        <div class="accordion-item">
                            <h2 class="mb-0">
                                <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Bagaimana Pembayaran boking?</button>
                            </h2>
            ...
            <div class="col-lg-4">
                <div class="custom-block" data-aos="fade-up" data-aos-delay="100">
                    <h2 class="section-title">Checkout Guide dan Porter</h2>
                    <?php
                    echo form_open_multipart('pendaki/cGuidePorter/checkout_ok');
                    ?>
