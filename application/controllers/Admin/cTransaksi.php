...
class cTransaksi extends CI_Controller
{
    ...
    public function boking()
    {
        ...
        $this->load->view('Admin/Layout/navbar');
        $this->load->view('Admin/Layout/aside');
        $this->load->view('Admin/Boking/vBoking', $data);
        $this->load->view('Admin/Layout/footer');
    }
    public function detail_boking($id)
    {
        ...
        $this->load->view('Admin/Layout/navbar');
        $this->load->view('Admin/Layout/aside');
        $this->load->view('Admin/Boking/vDetailBoking', $data);
        $this->load->view('Admin/Layout/footer');
    }
    ...
    public function stat_jaminan_menerima_boking($id)
    {
        $data = array(
            'stat_jaminan' => '1'
        );
    ...
    public function dikembalikan_boking($id)
    {
        $data = array(
            'stat_jaminan' => '2'
        );
